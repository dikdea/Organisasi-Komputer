simpangandiketahui2:
	...
	fld dword[kurangsatu]	;mengambil nilai = 1
	fsub					;fungsi untuk mengurangkan bnilai dengan 1
							;karena jika bnilai <= 30, maka nilai tersebut harus dikurang dengan 1
	fstp qword[kurang_satu]	;hasilnya disimpan di [kurang_satu]
    ...
    add esp, 20	;push sebanyak 5 kali jadi (5*4=20)
